class Users::OmniauthCallbacksController < Devise::OmniauthCallbacksControllerprivate
# プロバイダー情報を受取る
def callback_for(provider)  # ログイン情報をauthに入れる
  auth = request.env["omniauth.auth"]   # 登録されているユーザーと一致しなかった場合は新規でユーザーを作成
